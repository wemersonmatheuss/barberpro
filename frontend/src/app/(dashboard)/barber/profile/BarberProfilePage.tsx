...
export function BarberProfilePage() {
  ...
  const { profile, avatarPreviewUrl, setAvatarFile, clearAvatar, setProfileField } = useBarberProfile()
        ...
        <div className="grid gap-5 lg:grid-cols-2 lg:items-start lg:gap-6 xl:gap-8">
          <section className={panel}>
            ...
            <form onSubmit={handleSaveProfile} className="mt-6 space-y-4">
              <div>
                <label htmlFor="barber-profile-email" className="mb-1 block text-sm font-medium text-primary">
                  E-mail
                </label>
                <input id="barber-profile-email" type="email" value={email} readOnly className={`${inp} opacity-80`} />
              </div>
              <div>
                <label htmlFor="barber-profile-first" className="mb-1 block text-sm font-medium text-primary">
                  Nome
                </label>
                <input
                  id="barber-profile-first"
                  className={inp}
                  value={editFirstName}
              ...
              <div>
                <label htmlFor="barber-profile-last" className="mb-1 block text-sm font-medium text-primary">
                  Sobrenome
                </label>
                <input
                  id="barber-profile-last"
                  className={inp}
                  value={editLastName}
              ...
              <div>
                <label htmlFor="barber-profile-wa" className="mb-1 block text-sm font-medium text-primary">
                  WhatsApp
                </label>
                <input
                  id="barber-profile-wa"
                  className={inp}
                  value={editWhatsapp}
            ...
            <div className={panel}>
              ...
              {showPasswordSection ? (
                <form onSubmit={handleChangePassword} className="mt-4 space-y-4 border-t border-zinc-700/35 pt-6">
                  <div>
                    <label htmlFor="barber-new-pass" className="mb-1 block text-sm font-medium text-primary">
                      Nova senha
                    </label>
                    <input
                      id="barber-new-pass"
                  ...
                  <div>
                    <label htmlFor="barber-confirm-pass" className="mb-1 block text-sm font-medium text-primary">
                      Confirmar senha
                    </label>
                    <input
                      id="barber-confirm-pass"
                      type="password"
                      className={inp}
